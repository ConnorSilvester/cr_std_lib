...
void cr_std_string_test_all() {
    ...
    cr_std_vector_push_back(tests, cr_std_testing_new_test("Find String In String -> Invalid String", cr_std_string_test_find_string_invalid));
    ...
    // Char At
    cr_std_vector_push_back(tests, cr_std_testing_new_test("Char At -> Normal", cr_std_string_test_char_at));
    cr_std_vector_push_back(tests, cr_std_testing_new_test("Char At -> Invalid Index Low", cr_std_string_test_char_at_invalid_index_low));
    cr_std_vector_push_back(tests, cr_std_testing_new_test("Char At -> Invalid Index High", cr_std_string_test_char_at_invalid_index_high));
    cr_std_vector_push_back(tests, cr_std_testing_new_test("Char At -> NULL", cr_std_string_test_char_at_null));
...
int cr_std_string_test_find_last_string_valid() {
    String *string = cr_std_string_new("Hello Hello Hello Hello");
...
int cr_std_string_test_find_string_n_valid() {
    String *string = cr_std_string_new("Hello World World");
...
int cr_std_string_test_find_string_n_negative() {
    String *string = cr_std_string_new("World World World");
    int function_result = cr_std_string_find_string_n(string, "World", -2);
    int expected = 0;
    int result = string != NULL && function_result == expected;
    cr_std_string_free(&string);
